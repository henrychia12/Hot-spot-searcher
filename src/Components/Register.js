                    ...
                    <div class="col-md-6 mx-auto">
                        <div class="card card-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group has-error">
                                    <input class="form-control input-lg" placeholder="Full Name" name="fullname" type="text" />
                                </div>
                                <div class="form-group has-error">
                                ...
                                <div class="form-group has-success">
                                    <input class="form-control input-lg" placeholder="Confirm Password" name="password" type="password" />
                                </div>
                                <div class="checkbox">
                                    <label class="small">
